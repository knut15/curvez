...
| state         | 트리거        | 시각 변화                                               |
| ------------- | ------------- | ------------------------------------------------------- |
| default       | —             | bg=--card, border=--border, radius=--radius             |
...
- a11y:contrast — 제목 fg=--card-foreground / bg=--card 4.5:1 이상, 요약·날짜 fg=--muted-foreground / bg=--card 4.5:1 이상. 라이트 #737373/#FFFFFF = 4.74, 다크 #A1A1A1/#171717 = 5.05
