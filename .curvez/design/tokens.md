...
라이트는 teal, 다크는 mint 다. 홈(`/`)에만 쓰고 케이스 목록·상세는 위의 shadcn 토큰을 그대로 쓴다.
...
- fg=#14201E bg=#E4E8E7 mode=light min=4.5 # 랜딩 본문/랜딩 바탕
- fg=#0B6B63 bg=#E4E8E7 mode=light min=4.5 # 랜딩 강조/랜딩 바탕
- fg=#E6EDEA bg=#101514 mode=dark min=4.5 # 랜딩 본문/랜딩 바탕
- fg=#5EEAD4 bg=#101514 mode=dark min=4.5 # 랜딩 강조/랜딩 바탕
