...
```
에이전트 13종 · 스킬 16종 · 문서 11편 · 실행기 8종 · 훅 5종
```
...
| **벤더 스킬**     | mattpocock-skills 1.2.3 에서 7종, emilkowalski/skills 에서 애니메이션·디자인 10종 복사 (둘 다 MIT). 출처·버전·복사일은 각 `plugins/curvez/vendor/*/VENDOR.md` |
